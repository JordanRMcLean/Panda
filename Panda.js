/*  Panda.js Updated for practise with ES6 script. */

(function (win, doc) {

    //no need for a class on this occasion
    //besides we want defined properties.
    const Panda = {

        //unique id for replacing and returning text
        replacerID: 'panda_' + (new Date()).getTime() + '_',

        //will store the language objects which define how to parse
        //each lang will have matchers (regex matchers), keywords and specials
        languages: {},

        //regular expressions needed, key represents what part of a code they identify
        //the key also becomes the classname to use within CSS.
        regex: {
            comment1: /\/\/[^\n]*/g,
            comment2: /\/\*(.|[\n\r])*?\*\//gm,
            comment3: /#[^\n]*/g,
        ...
        //Simply find and parse all code elements. Optional.
        init() {
        ...
        //alias for legacy. Used to be onload and used on some sites.
        onload() {
            this.init();
        },

        //match panda_lang (lang)
        //TODO: Can this be cleaner with classList?
